...
import ITEbg from "../public/image/ITEbg.jpg";
import ITES1 from "../public/image/ITES1.jpg";
import '../public/CSS/Effect.css';
        ...
        <div className="bg-black text-white px-10 mt-20 w-full">
            ...
            <section className="relative w-full">
                <div className="grid grid-cols-2 gap-4 pt-20">
                    <div>
                    <Image src={ITES1} alt="" className="object-cover w-full max-h-[80vh]" />
                    </div>
                    <div>
            ...
            <div className="flex flex-wrap justify-center mt-20 text-center">
              ...
              <div className="mb-10 px-10 w-full md:w-1/3 flex flex-col items-center">
                ...
                <p className="text-[14px] md:text-[16px]">
                  合VTC新型工業化及科技培訓計劃」（NITTP）資格的培訓機構。該計劃可獲得企業就讀的課程費用50%的資助額。
課程類型包括：自動控制；銀行；生物醫學及醫護；數據通訊；數碼媒體；電子工程；環保；旅遊及飲食業；資訊科技；保險業相關科技；物流業相關科技；職業健康及安全；製造；印刷及出版；品質改善；可持續發展；紡織及製衣；批發/零售及出入口貿易；食品與健康科學等等。</p>
              </div>
