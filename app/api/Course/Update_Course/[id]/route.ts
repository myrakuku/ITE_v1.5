...
//   id: string;
//   timeRange: string;
//   starttime: string | null; // 改為 starttime
//   endtime: string | null;   // 改為 endtime
// }
...
//       z.object({
//         timeRange: z.enum(['morning', 'afternoon', 'evening', 'full_day']),
//         starttime: z.string().optional().nullable(), // 改為 starttime
//         endtime: z.string().optional().nullable(),   // 改為 endtime
//       }),
//     )
//     .optional(),
//   courseDates: z.array(z.string().datetime()).optional(),
//   weekday: z.string().optional().nullable(),
//   classroom: z.string().optional().nullable(),
// });
...
//       ...(validatedData.timeRanges && validatedData.timeRanges.length > 0
//         ? [
//             db.courseTimeRange.createMany({
//               data: validatedData.timeRanges.map((tr) => ({
//                 courseId: id,
//                 timeRange: tr.timeRange,
//                 starttime: tr.starttime, // 改為 starttime
//                 endtime: tr.endtime,     // 改為 endtime
//               })),
//             }),
//           ]
//         : []),
...
//             id: true,
//             timeRange: true,
//             starttime: true, // 改為 starttime
//             endtime: true,   // 改為 endtime
//           },
//         },
//       },
//     });
