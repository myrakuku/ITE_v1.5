            ...
            <div className="flex flex-col md:flex-row md:space-x-6">
              <div className="flex-1">
                <div className="space-y-2">
                  ...
                  <div>
                    <span className="font-medium">價格:</span> HK${GetProductDatabyId.price.toFixed(2)}
                  </div>
                  <div>
                    <span className="font-medium">實際價格:</span>{" "}
                    {GetProductDatabyId.real_price ? `HK$${GetProductDatabyId.real_price.toFixed(2)}` : "N/A"}
                  </div>
                  <div>
                    <span className="font-medium">公開狀態:</span>{" "}
                    {GetProductDatabyId.IsPublic ? "公開" : "不公開"}
              ...
              <div className="mt-4 md:mt-0">
                ...
                {GetProductDatabyId.Product_Img && GetProductDatabyId.Product_Img.length > 0 ? (
                  <Image
                    ...
                    width={300}
                    height={300}
                    className="mt-2 w-full max-w-xs rounded-md shadow-md object-cover"
                    priority={true} // 詳情頁圖片優先加載
                    placeholder="blur"
                    blurDataURL="/placeholder-image.jpg" // 提供本地占位圖
                  />
                ) : (
                  <Image
