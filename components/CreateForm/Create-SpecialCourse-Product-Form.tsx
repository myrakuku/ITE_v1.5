...
//       } catch (_err) {
//         const errorMessage =
//           _err instanceof Error ? _err.message : "無法獲取課程數據";
...
//       } catch (_err) {
//         const errorMessage =
//           _err instanceof Error ? _err.message : "無法獲取類型數據";
//         setError(errorMessage);
//         toast.error(errorMessage);
//       }
//     };
...
//       } catch (_err) {
//         const errorMessage =
//           _err instanceof Error ? _err.message : "無法獲取狀態數據";
//         setError(errorMessage);
//         toast.error(errorMessage);
//       }
//     };
...
//   }, []); // 移除 handleCourseSelect 和 selectedCourseId 依賴

//   useEffect(() => {
//     if (initialCourse && !selectedCourseId) {
//       handleCourseSelect(initialCourse);
//     }
//   }, [initialCourse, handleCourseSelect]); // 移除 selectedCourseId 依賴
